...
const FrozenRows = () => {
    ...
    const lockTemplate = (rowData: any, options: { frozenRow: any; rowIndex: number; }) => {
    ...
    // const toggleLock = (data: any, frozen: any, index: number) => {
    ...
    //     }
    //     else {
    //         _unlockedCustomers = unlockedCustomers.filter((c: any, i: number) => i !== index);
  ...
  return (
    <div className='px-6 '>
        ...
        <DataTable value={tableData} frozenValue={lockedCustomers} scrollable scrollHeight="400px">
