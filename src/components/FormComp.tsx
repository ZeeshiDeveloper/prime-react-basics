...
const FormComp = () => {
	...
	return (
		<>
			<h1 className="text-center text-green-700 border-bottom-2 w-24rem flex justify-content-center mx-auto">
			...
			<Card className="w-28rem bg-surface-0 border-round flex flex-column mx-auto p-2 hover:shadow-8">
				...
				<form action="" onSubmit={handleSubmit}>
					...
					{errors.name && touched.name ? (
						<p className="mb-3 -mt-3 text-sm text-red-500">{errors.name}</p>
					) : null}
					...
					{errors.email && touched.email ? (
						<p className="mb-3 -mt-3 text-sm text-red-500">{errors.email}</p>
					) : null}
					...
					{errors.password && touched.password ? (
						<p className="mb-3 -mt-3 text-sm text-red-500">{errors.password}</p>
					) : null}
					...
					{errors.dob && touched.dob ? (
						<p className="mb-3 -mt-3 text-sm text-red-500">{errors.dob.toString()}</p>
					) : null}
					...
					{errors.country && touched.country ? (
						<p className="mb-3 -mt-3 text-sm text-red-500">{errors.country}</p>
					) : null}
					...
					{errors.checkbox && touched.checkbox ? (
						<p className="mb-3 -mt-3 text-sm text-red-500">{errors.checkbox}</p>
					) : null}
